...
import 'package:keep_it_alive_server/src/generated/protocol.dart';
import 'package:keep_it_alive_server/src/generated/endpoints.dart';
...
class _FlameEndpoint {
  ...
  _ida.Future<String> getCurrentHolder(
    _ist.TestSessionBuilder sessionBuilder,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
...
class _GreetingEndpoint {
  ...
  _ida.Future<_ils43cnz.Greeting> hello(
    _ist.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
